...
class DocumentsUploadEdit extends StatelessWidget {

  final List list;
  DocumentsUploadEdit( this.list);

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Documentsuploadstateful(list),
...
class Documentsuploadstateful extends StatefulWidget {
  ...
  final List list;
  Documentsuploadstateful(this.list);
...
class Documentsuploadscreen  extends State<Documentsuploadstateful>{
  ...
  initProofs() async {
    ...
    final _response = await Provider.of<ApiService>(context, listen: false)
        ...
        {
          "type": "proofs",
          "userId": widget.list[3],                   // blog , caste , roles , all_staff
  ...
  Widget build(BuildContext context) {
    ...
    appBar: AppBar(
    title: Text('Upload Documents' , style: TextStyle(color: Colors.black87 , fontSize: 18),),
    toolbarOpacity: 1,
   ...
   ConnectivityResult result = await Connectivity().checkConnectivity();
    ...
    if(listimagesPath.length == 1) {
        ...
        request.fields["id_proof_old"] =  path1;
        request.fields["id_education_old"] =  path2;
        request.fields["id_income_old"] =  path3;
    ...
    body:SafeArea(child: SingleChildScrollView(child: Column(children: [
      Container(width: MediaQuery.of(context).size.width , margin: EdgeInsets.only(left:18 , bottom: 10) ,child:Text("Identity Proof" , textAlign: TextAlign.left, style: TextStyle(fontWeight: FontWeight.bold , fontSize: 20),),),
    Center(
    child:  DottedBorder(
    borderType: BorderType.RRect,
      ...
      imageUrl: Strings.IMAGE_BASE_URL+"/uploads/matrimonial_photo/Matrimonial_Photo/"+path1, // Replace with your network image URL
      borderRadius: 12.0,
      ...
      Center(
        child:  DottedBorder(
          ...
          imageUrl: Strings.IMAGE_BASE_URL+"/uploads/matrimonial_photo/Matrimonial_Photo/"+path2, // Replace with your network image URL
          borderRadius: 12.0,
      ...
      Center(
        child:  DottedBorder(
          ...
          imageUrl: Strings.IMAGE_BASE_URL+"/uploads/matrimonial_photo/Matrimonial_Photo/"+path3, // Replace with your network image URL
          borderRadius: 12.0,
